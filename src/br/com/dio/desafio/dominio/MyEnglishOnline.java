...
public class MyEnglishOnline {
		...
		@Override
		public int hashCode() {
			return Objects.hash(alunosInscritos, conteudos, dataFinal, dataInicial, descricao, nome);
		}
		@Override
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			MyEnglishOnline other = (MyEnglishOnline) obj;
			return Objects.equals(alunosInscritos, other.alunosInscritos) && Objects.equals(conteudos, other.conteudos)
